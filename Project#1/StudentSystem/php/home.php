...
<body>
  <nav class="navbar fixed-top navbar-expand-lg navbar-light" style="background-color: #fd7e14;">
    <a class="navbar-brand" href="#" ><img src="tobb_etu.png" style="height: 40px; width: 200px;" alt="TOBB ETU"></a>
    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
      ...
      /**
       * TODO: XSS Injection Example
       *
       * xssParam parametre aldýðý ve echo ile yazdýrýldýðý varsayýlmaktadýr
       */
      $xssParam = $_GET['xssParam'];
      echo $xssParam;
      ...
      function drawLayout($id,$name,$eid,$salary,$birth,$ssn,$pwd,$nickname,$email,$address,$phoneNumber){
        ...
        if ($name !="Admin") {
          ...
          echo "<a class='nav-link' href='edit_profile.php'>Edit Profile</a>";
          echo "</li>";
          echo "</ul>";
      ...
      <div class="text-center">
        <p>
          Copyright &copy; TOBB ETU BIL520
        </p>
      </div>
    </div>
